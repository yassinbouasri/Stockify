<div>
    <form class="" wire:submit="save">
        ...
        <div class=" mx-4 my-4">
            ...
            <select class="w-1/4 p-1 border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" wire:model="form.category_id">
